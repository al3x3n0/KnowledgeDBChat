...
SPECS: tuple[ToolSpec, ...] = (
    ...
    ToolSpec(
        ...
        description=(
            ...
            "right answer -- and where a paper gives none, which is most of "
            "them, the properties it states do that job instead; and the "
            "claims are the paper's own measured "
