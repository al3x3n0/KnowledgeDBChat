...
# Combine all tools
# The measurement and sandbox family declares itself once, in
# agent_core.tool_specs, and the schema a model reads is derived from that
# declaration rather than kept in step with it by hand.
AGENT_TOOLS = AGENT_TOOLS + AUTONOMOUS_AGENT_TOOLS + tool_specs.schemas()
