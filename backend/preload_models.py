...
def preload_whisper_model(model_size: str = "small", model_dir: Optional[Path] = None):
    ...
    try:
        ...
        try:
            ...
            logger.warning(
                "SSL config not available, continuing without SSL configuration"
            )
        ...
        whisper.load_model(model_size, download_root=str(whisper_cache))
...
if __name__ == "__main__":
    ...
    success = preload_whisper_model(
        model_size=args.model_size, model_dir=args.model_dir
    )
