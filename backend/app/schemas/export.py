...
class ExportChatRequest(BaseModel):
    ...
    title: Optional[str] = Field(
        None, description="Document title (defaults to chat topic)"
    )
    style: Literal["professional", "casual", "technical"] = Field(
        "professional", description="Document style"
    )
    custom_theme: Optional[ExportTheme] = Field(
        None, description="Custom theme settings"
    )
...
class ExportDocumentSummaryRequest(BaseModel):
    ...
    format: Literal["docx", "pdf"] = Field("docx", description="Output format")
    title: Optional[str] = Field(
        None, description="Document title (defaults to source document title)"
    )
    style: Literal["professional", "casual", "technical"] = Field(
        "professional", description="Document style"
    )
...
class ExportCustomRequest(BaseModel):
    ...
    content_format: Literal["markdown", "html", "plain"] = Field(
